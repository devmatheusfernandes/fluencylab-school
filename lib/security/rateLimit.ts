...
import { RateLimitOperationType, DEFAULT_RATE_LIMITS } from "@/types/core/auth";
 ...
 */
export const cancellationRateLimiter = (
  request: NextRequest,
  userId: string,
) => {
 ...
 */
export const adminOperationRateLimiter = (
  request: NextRequest,
  userId: string,
) => {
  const rateLimiter = RateLimiter.getInstance();
 ...
 */
export const userCreationRateLimiter = (
  request: NextRequest,
  userId: string,
) => {
  const rateLimiter = RateLimiter.getInstance();
 ...
 */
export const studentCancellationRateLimiter = (
  request: NextRequest,
  userId: string,
) => {
  const rateLimiter = RateLimiter.getInstance();
 ...
 */
export const teacherCancellationRateLimiter = (
  request: NextRequest,
  userId: string,
) => {
  const rateLimiter = RateLimiter.getInstance();
 ...
 */
export const studentRescheduleRateLimiter = (
  request: NextRequest,
  userId: string,
) => {
  const rateLimiter = RateLimiter.getInstance();
 ...
 */
export const teacherRescheduleRateLimiter = (
  request: NextRequest,
  userId: string,
) => {
  const rateLimiter = RateLimiter.getInstance();
 ...
 */
export const adminRescheduleRateLimiter = (
  request: NextRequest,
  userId: string,
) => {
  const rateLimiter = RateLimiter.getInstance();
