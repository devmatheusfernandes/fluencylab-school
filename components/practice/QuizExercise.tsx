    ...
    <div className="w-full max-w-2xl mx-auto space-y-8">
          ...
          {options.map((option, index) => (
            <Button
              ...
              className={cn(
                ...
                selected === index
                  ? index === correctIndex
                    ? "border-green-500 bg-green-50 dark:bg-green-950/30 ring-2 ring-green-500"
                    : "border-rose-500 bg-rose-50 dark:bg-rose-950/30 ring-2 ring-rose-500"
                ...
                className={cn(
                  ...
                  selected === index
                    ? index === correctIndex
                      ...
                      : "border-rose-500 text-rose-700 bg-rose-200"
      ...
      {audioSegment && (
        <PracticeAudioPlayer
          ...
          startTime={Number(audioSegment.start)}
          endTime={Number(audioSegment.end)}
