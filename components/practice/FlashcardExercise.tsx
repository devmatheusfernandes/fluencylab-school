        ...
        >
          <div className="absolute inset-0 backface-hidden bg-white dark:bg-slate-900 rounded-3xl border-b-4 border-slate-200 dark:border-slate-700 shadow-xl flex flex-col items-center justify-center p-8 text-center">
            ...
            <div className="text-3xl font-bold text-slate-700 dark:text-slate-200">
              {front}
              {isLocked && (
                <div className="text-xl font-medium text-slate-600 dark:text-slate-300 opacity-60">
                  {back}
                </div>
              )}
            </div>
            <p className="absolute bottom-8 text-slate-400 text-sm uppercase tracking-widest font-bold">
              Tap to flip
            </p>
          </div>
          ...
          {isFlipped && (
            ...
            >
              <Button
                ...
                disabled={isLocked}
                className="border-none h-14 rounded-xl bg-rose-500 hover:bg-rose-600 text-white font-bold text-sm shadow-[0_4px_0_0_#be123c] active:translate-y-1 active:shadow-none transition-all px-1"
                title="Fail / Again"
              >
                Again
              </Button>
              <Button
                ...
                disabled={isLocked}
                className="border-none  h-14 rounded-xl bg-amber-500 hover:bg-amber-600 text-white font-bold text-sm shadow-[0_4px_0_0_#b45309] active:translate-y-1 active:shadow-none transition-all px-1"
                title="Hard"
              >
                Hard
              </Button>
              <Button
                ...
                disabled={isLocked}
                className="border-none h-14 rounded-xl bg-indigo-500 hover:bg-indigo-600 text-white font-bold text-sm shadow-[0_4px_0_0_#4338ca] active:translate-y-1 active:shadow-none transition-all px-1"
                title="Good"
              >
                Good
              </Button>
              <Button
                ...
                disabled={isLocked}
                className="border-none  h-14 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-sm shadow-[0_4px_0_0_#047857] active:translate-y-1 active:shadow-none transition-all px-1"
                title="Easy"
              >
                Easy
              </Button>
