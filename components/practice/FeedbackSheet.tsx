...
export function FeedbackSheet({ isOpen, isCorrect, correctAnswer, explanation, grade, onContinue }: FeedbackSheetProps) {
  ...
  const bgClass = {
    rose: "bg-rose-100 border-rose-200 dark:bg-rose-950/30 dark:border-rose-900",
    amber: "bg-amber-100 border-amber-200 dark:bg-amber-950/30 dark:border-amber-900",
    indigo: "bg-indigo-100 border-indigo-200 dark:bg-indigo-950/30 dark:border-indigo-900",
    emerald: "bg-emerald-100 border-emerald-200 dark:bg-emerald-950/30 dark:border-emerald-900",
    green: "bg-green-100 border-green-200 dark:bg-green-950/30 dark:border-green-900",
    slate: "bg-slate-100 border-slate-200 dark:bg-slate-950/30 dark:border-slate-900"
  ...
  const buttonClass = {
    ...
    emerald: "bg-emerald-500 hover:bg-emerald-600 text-white shadow-emerald-700",
