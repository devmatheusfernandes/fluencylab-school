...
function StatCard({ title, value, icon, variant }: StatCardProps) {
  ...
  return (
    <div className={cn(
      "relative overflow-hidden rounded-2xl p-3 lg:p-4 shadow-sm border-0 transition-all hover:contrast-[1.2] ease-in-out duration-300 cursor-pointer",
      colorMap[variant],
...
export function StatsDashboard({ reviewedToday, dueToday, totalLearned }: StatsDashboardProps) {
  return (
    // LÓGICA DO LAYOUT:
