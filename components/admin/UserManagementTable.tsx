        ...
        <div className="w-full md:w-auto flex flex-col gap-2">
          <div className="flex flex-col sm:flex-row gap-2">
            <div className="relative w-full">
              ...
              <Input
                placeholder={
                  t("searchPlaceholder") || "Buscar por nome, email ou CPF..."
                }
                value={searchQuery}
      ...
      <Card className="overflow-hidden">
        <div className="overflow-x-auto">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="text-subtitle w-full md:w-auto">
                  {t("user")}
                </TableHead>
                <TableHead className="text-subtitle hidden sm:table-cell">
                  {t("type")}
                </TableHead>
