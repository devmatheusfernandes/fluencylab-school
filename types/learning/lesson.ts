...
export interface LearningStructure {
  ...
  sentences: Array<{
    //Serão criadas com base no type (podemos escolher mais de um)
    words: string; // "I eat a lot" The whole sentence
    order: Array<{
      //Assim conseguimos fazer o usuário praticar a ordem das palavras corretamente
...
export interface Lesson {
  ...
  // A FILA: O Gemini deposita aqui, o Batch processa e remove daqui
  learningStructuresQueue: Array<
    Omit<LearningStructure, "id" | "metadata" | "language">
  >;
